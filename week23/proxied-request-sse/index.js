    ...
    const response = await fetch('http://localhost:5050/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a senior software developer that provide guide and encouragement', // This is the system message, it will control the behavior of the chatbot
          },
          {
            role: 'user',
